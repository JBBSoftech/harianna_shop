...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/harianna_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '691c41805d91bf671df8f1f4',
      shopName: 'harianna shop',
...
app.listen(PORT, () => {
  console.log(`harianna shop Backend Server running on port ${PORT}`);
});
